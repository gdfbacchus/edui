exports.getTransactionRecord = function (res, req) {
  ...
  return new Promise((resolve, reject) => {
    res.locals.connectionPool.getConnection(function(err, connection) {
      ...
      var queryCheckTxDataExists = "SELECT txid, num_of_confirmations FROM `ltc_deposit` where txid=" + connection.escape(txId) + ";";
...
exports.insertTransaction = function (res, req, txData, type, currentUtcTime) {
  return new Promise((resolve, reject) => {
    res.locals.connectionPool.getConnection(function(err, connection) {
      ...
      var insertQuery = "INSERT INTO `ltc_deposit`(`txid`, `received_by_address`, `amount`, `num_of_confirmations`, `account_name`, `type`, `start_date`) " +
        "VALUES ("
...
exports.updateTransaction = function (res, req, txData) {
  return new Promise((resolve, reject) => {
    res.locals.connectionPool.getConnection(function(err, connection) {
      ...
      var updateQuery = "UPDATE `ltc_deposit` SET "
  ...
  return new Promise((resolve, reject) => {
    res.locals.connectionPool.getConnection(function(err, connection) {
      ...
      var updateQuery = "UPDATE `ltc_deposit` SET "
        ...
        + " , `status_of_tx`=" + connection.escape(status)
        + " , `end_date`= " + connection.escape(currDate) +
...
exports.insertInitWithdrawData = function (req, res, amount, easydexCode, startTime) {
  return new Promise((resolve, reject) => {
    res.locals.connectionPool.getConnection(function(err, connection) {
      ...
      var insertQuery = "INSERT INTO `ltc_withdrawal`(" +
        "`from_account`, " +
        "`to_account`, " +
        "`amount`, " +
        "`asset`, " +
...
exports.updateWithdrawData = function (res, easydexCode, btsTxid,  btcTxid, status) {
  return new Promise((resolve, reject) => {
    res.locals.connectionPool.getConnection(function(err, connection) {
      ...
      var updateQuery = "UPDATE `ltc_withdrawal` SET "
