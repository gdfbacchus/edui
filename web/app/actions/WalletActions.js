...
class WalletActions {
    ...
    createAccountWithPassword( account_name, password, registrar, referrer, referrer_percent, refcode ) {
        ...
        // console.log("create account1:", account_name);
        // console.log("new active_private pubkey", active_private.toPublicKey().toPublicKeyString());
        // console.log("new owner_private pubkey", owner_private.toPublicKey().toPublicKeyString());
