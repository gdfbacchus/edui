...
import BurgerMenuContainer from "./components/Menu/BurgerMenu/BurgerMenuContainer";
        ...
        if (this.state.syncFail) {
            ...
            content = (
                <div className="grid-frame vertical">
                    ...
                    <div className="newsBanner2">
                        <div className="newsBanner">
                            <div>
                                <Translate content="news.scrolling_banner_txt_1"/>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <Translate content="news.scrolling_banner_txt_3"/>
                            </div>
                        </div>
                    </div>
                    <BurgerMenuContainer/>
                    <div className="grid-block align-center  main-wrapper-content">
                        {this.props.children}
                    </div>
