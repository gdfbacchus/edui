...
class AccountStore extends BaseStore {
  constructor() {
    ...
    this.bindListeners({
      ...
      onStoreEncryptedPassword: AccountActions.storeEncryptedPassword,
      onUsernameVerification: AccountActions.usernameVerification,
      onRecoveryTokenVerification : AccountActions.recoveryTokenVerification,
      onRecoveryPasswordAnswerVerification : AccountActions.recoveryPasswordAnswerVerification,
  ...
  onStoreEncryptedPassword(payload) {
    //console.log('received payload at the store: ', payload);
  }

  onUsernameVerification(payload) {
    //console.log('received payload at the store: ', payload);
  }

  onRecoveryTokenVerification(payload) {
    //console.log('received payload at the store: ', payload);
  }

  onRecoveryPasswordAnswerVerification(payload) {
    //console.log('received payload at the store: ', payload);
  }
}
