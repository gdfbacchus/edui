    ...
    _renderAccountCreateText() {
        ...
        return (
            <div className="confirm-checks" >
                <div className="grid-content small-12 text-center" style={{maxWidth: "95vw"}}>
                    <img src="/app/assets/EasyDex-logo-text-white-small.png" />
                ...
                <Translate style={{textAlign: "left"}} component="p" content="wallet.create_local_account_text_1" />
                <Translate style={{textAlign: "left"}} component="p" content="wallet.create_local_account_text_2" />
