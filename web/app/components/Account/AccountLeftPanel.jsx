...
class AccountLeftPanel extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="grid-block vertical account-left-panel no-padding no-overflow" style={{width: "240px"}}>
                <div className="grid-block">
                    <div className="grid-content no-padding" style={{overflowX: "hidden"}}>
                        ...
                        <div className="regular-padding">
                            ...
                            />
                            <div className="grid-container no-margin" style={{paddingTop: 20, width: "184px"}}>
                                <Link to={`/deposit-withdraw/`}><div style={{paddingBottom: 15}}><Translate className="button block-button no-margin" content="account.deposit_withdraw"/></div></Link>
                                {isMyAccount ? <div style={{paddingBottom: 15}}><Link to={`/transfer/?to=${account_name}`}><Translate className="button block-button no-margin" content="account.pay"/></Link></div> :  null}
                            </div>
                        </div>
