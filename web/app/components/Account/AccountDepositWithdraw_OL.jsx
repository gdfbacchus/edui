...
import BlockTradesGateway from "../DepositWithdraw/BlockTradesGateway_OL";
...
class AccountDepositWithdraw_OL extends React.Component {
...
AccountDepositWithdraw_OL = BindToChainState(AccountDepositWithdraw_OL);
...
class DepositStoreWrapper extends React.Component {
  ...
  render() {
    return <AccountDepositWithdraw_OL {...this.props} />;
  }
}
