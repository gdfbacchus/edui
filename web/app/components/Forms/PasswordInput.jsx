...
class PasswordInput extends Component {
    ...
    constructor() {
        ...
        this._setGeneratedPass = this._setGeneratedPass.bind(this);
        this._onGeneratePassword = this._onGeneratePassword.bind(this);
    ...
    handleChange(e) {
        ...
        let state = {
            ...
            value: password,
            doesnt_match,
            generatedPassword: e.target.name==="password" ? "" : this.state.generatedPassword
        };
    ...
    render() {
        ...
        return (
            <div className="account-selector">
                ...
                {this.props.hideGenPassword && this.props.hideGenPassword == true ? null :
                    <section>
                        <button onClick={this._onGeneratePassword} className="button generate-pass-btn">
                            <Translate content="wallet.generate_pass_btn" />
                        </button>
                    </section>
                }
