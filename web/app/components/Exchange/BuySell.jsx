...
class BuySell extends React.Component {
    ...
    render() {
        let {type, typeB, quote, base, amountChange, fee, isPredictionMarket,
...
/*        var quoteMarketFee = quoteFlagBooleans["charge_market_fee"] ? (
        ...
        return (
            <div className={this.props.className}>
                <div className="exchange-bordered buy-sell-container market-block-grey-bg">
                    <div className={type + " " + typeB}>
