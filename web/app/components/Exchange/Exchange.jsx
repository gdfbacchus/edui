            ...
            <div className="grid-block page-layout market-layout">
              ...
              {/* Left Column - Market History */}
                <div className="grid-block shrink right-column no-overflow vertical show-for-medium" style={{paddingTop: 0, minWidth: 358, maxWidth: 400}}>
                  {/* Market History */}
                    <div className="grid-block no-padding no-margin vertical market-block-grey-bg" style={{flex: "1 1 auto"}}>
                        <MyMarkets
                    ...
                    {/*<div style={{padding: !this.props.miniDepthChart ? 0 : "0 0 40px 0"}} className="grid-block no-margin vertical shrink market-block-grey-bg">*/}
                ...
                <div style={{paddingTop: 0}} className={cnames("grid-block main-content vertical no-overflow")} >
                    ...
                    <div className="grid-block vertical no-padding ps-container" id="CenterContent" ref="center">
                        {!showDepthChart ? (
                            <div className="grid-block shrink no-overflow" id="market-charts" style={{marginBottom: "10px"}}>
                                {/* Price history chart */}
                                <PriceChartD3
                            ...
                            <div className="grid-block vertical no-padding shrink market-block-grey-bg" >
                                <DepthHighChart
                                    marketReady={marketReady}
                                    orders={marketLimitOrders}
                                    showCallLimit={showCallLimit}
                        ...
                        <div className="grid-block no-overflow wrap shrink" >
                          ...
                          {marketLimitOrders.size > 0 && base && quote ? (
                            <MyOpenOrders
                              ...
                              className={cnames(
                                ...
                                `small-12 medium-6 no-padding align-spaced ps-container middle-content xlarge-order-3`
                              )}
                              key="open_orders"
                              orders={marketLimitOrders}
                              currentAccount={currentAccount}
                          ...
                          {/* MY TRADES / MARKET TRADES */}
                            <MarketHistory
                              className={cnames(
                                !smallScreen && !leftOrderBook ? "medium-6 xlarge-4" : "",
                                "no-padding no-overflow middle-content small-12 medium-6 order-5 xlarge-order-6"
                              )}
                              headerStyle={{paddingTop: 0}}
