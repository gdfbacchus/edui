...
class MyMarkets extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            //activeTab: props.viewSettings.get("favMarketTab", "find-market"),//default tab
            activeTab: "find-market",//default tab
    ...
    render() {
        ...
        let myMarketTab = activeTab === "my-market"//"find-market";
        //myMarketTab = false;//prevent EASY MARKET TAB
        ...
        return (
            <div className={this.props.className} style={this.props.style}>
                ...
                >
                    <div className={allClass} onClick={this._changeTab.bind(this, "find-market")} style={{width: "100%"}} >
                ...
                {myMarketTab ?
                  <div className="grid-block shrink"
                      ...
                      <label className="no-margin">
                          <input style={{position: "relative", top: 3}} className="no-margin" type="checkbox"
                                 checked={this.props.onlyStars} onChange={() => {
                            MarketsActions.toggleStars();
                          }}/>
                          <span>&nbsp;<Translate content="exchange.show_star_1"/><Icon className="gold-star"
                                                                                       name="fi-star"/> <Translate
                            content="exchange.show_star_2"/></span>
                      </label>
