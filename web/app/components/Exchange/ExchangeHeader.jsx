...
export default class ExchangeHeader extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="grid-block shrink no-padding overflow-visible top-bar market-block-darkpurple-bg">
                <div className="grid-block overflow-visible" style={{borderTop: "1px solid rgba(128, 128, 128, 0.45)",borderLeft: "1px solid #674684"}}>
                    <div className="grid-block shrink show-for-large" style={{borderRight: "1px solid #674684"}}>
