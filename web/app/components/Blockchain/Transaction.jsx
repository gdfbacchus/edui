...
import { hiddenMemoAssetIds } from "assets/constants/assets";
...
class Transaction extends React.Component {
  ...
  render() {
    ...
    trx.operations.forEach((op, opIndex) => {
      ...
      let showMemo = true;
      if(op[1] && op[1].amount && op[1].amount.asset_id){
        showMemo = hiddenMemoAssetIds.indexOf(op[1].amount.asset_id) < 0;
        // console.log("hiddenMemoAssetIds: ",hiddenMemoAssetIds);
        // console.log("showMemo: ",showMemo);
        // console.log("op[1].amount: ",op[1].amount);
      }
      // console.log("showMemo: ",showMemo);
      ...
      switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
        case "transfer":
          ...
          rows.push(
            <tr key={key++}>
              ...
              <td><FormattedAsset amount={op[1].amount.amount} asset={op[1].amount.asset_id} dysplayAssetName={true}/></td>
            </tr>
          );
        ...
        case "asset_reserve":
          ...
          rows.push(
            <tr key={key++}>
              <td><Translate component="span" content="transfer.amount"/></td>
              <td><FormattedAsset amount={op[1].amount_to_reserve.amount} asset={op[1].amount_to_reserve.asset_id}/>
              </td>
            </tr>
          );
          break;
